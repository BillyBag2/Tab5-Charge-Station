...
- [x] Target the M5Stack TAB5.
- [x] Leverage the standard libraries M5Unified, and M5GFX where possible.
...
- [x] Offer the ability to turn on or off charging using a Display GUI.
- [x] Offer the ability to change the charge rate.
- [x] If power charging power is lost and then restored the TAB5 should continue
      charging in the same way as before the power loss.
- [x] Estimate the percentage battery charge state from the battery voltage.
- [ ] Use the Arduino IDE.
- [x] Code in c++.
- [x] Create separate source files for different features of the code and
